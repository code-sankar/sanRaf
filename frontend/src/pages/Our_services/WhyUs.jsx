  ...
  const features = [
    {
      ...
      description:
        "We ensure top-tier code quality, security, and data protection across all our solutions.",
    ...
    },
    {
      ...
      description:
        "Our developers, designers, and strategists work closely to bring your vision to life.",
    ...
    },
    {
      ...
      description:
        "We follow agile workflows and milestone tracking to deliver projects efficiently.",
      highlights: [
        "Agile Methodology",
        "Milestone Tracking",
        "Quick Deployment",
    ...
    },
    {
      ...
      description:
        "We leverage the latest frameworks — React, Node.js, Next.js, and more for scalable solutions.",
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            We're not just another development team — we're your trusted
            technology partners, turning complex ideas into seamless, scalable
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => (
            <div
              key={index}
              className={`bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-blue-100 text-center transition-all duration-700 delay-${
                index * 100
              } ${
                isVisible
        ...
        {/* CTA Section */}
        <div
          className={`text-center bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-white shadow-2xl transition-all duration-1000 delay-700 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button
              className="bg-white text-blue-600 px-8 py-4 rounded-2xl font-semibold hover:bg-blue-50 transition-all duration-300 flex items-center gap-2 group"
        ...
        {/* Trust Badges */}
        <div
          className={`flex flex-wrap justify-center items-center gap-8 mt-16 opacity-70 transition-all duration-1000 delay-1000 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
        >
